...
//         });
        ...
        $("#agent_selected").change(function() {
            ...
            $('#disease_selected').change(function(e){
                ...
                //var query = "#query{occurrences_by_taxon_hospederos(query: \"nombreenfermedad='"+ _DISEASE_TEXT_SELECTED +"'\"){reino phylum clase orden familia genero nombrecientifico}}"
                var query = "query{occurrences_by_taxon_"+ nodo + "(query: \"nombreenfermedad='"+ _DISEASE_TEXT_SELECTED +"'\"){reino phylum clase orden familia genero nombrecientifico}}"
